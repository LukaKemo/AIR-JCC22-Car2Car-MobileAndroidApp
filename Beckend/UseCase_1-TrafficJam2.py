...
def main():
    time.sleep(2)
    t1 = threading.Thread(target=simulate_car_movement, args=(46.298725, 16.293845, 46.292765, 16.306121, 120, 4))
    t2 = threading.Thread(target=simulate_car_movement, args=(46.290330, 16.298802, 46.292607, 16.306498, 130, 5))
    t3 = threading.Thread(target=simulate_car_movement, args=(46.297090, 16.313295, 46.292753, 16.306347, 150, 6))
    t1.start()
    time.sleep(1.25)
    t2.start()
    time.sleep(1.25)
